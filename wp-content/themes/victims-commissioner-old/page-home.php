			...
			?><a href = "<?php echo $action_url; ?>">
				<div class = "home-action-container">
					...
					<div class = "action-text">
						<p><?php echo ot_get_option( "homepage_cta" . $x . "_text" ); ?></p>
...
<div class="row new-section">
	<div class="col-sm-6 home-news-col">
		...
		foreach ( $news as $newspost ) {
			...
			?>
			<article>
				<h1><?php echo get_the_title( $news_id ); ?></h1>
				<div class='news-meta'>
					<a href='<?php echo get_author_posts_url( $newspost->post_author ); ?>' class='news-meta-author'><?php echo get_the_author_meta( 'user_nicename', $newspost->post_author ); ?></a>, <?php echo get_the_date( "j F, Y", $news_id ); ?>
				</div>
